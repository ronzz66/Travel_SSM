						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" data-toggle="modal" data-target="#myModal">
												...
												<div class="box-body">
													<div class="form-horizontal">
														<div class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" name="permissionName" class="form-control" placeholder="权限名">
															</div>
														</div>
														<div class="form-group">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc">权限</th>
										<th class="sorting_asc sorting_asc_disabled">URI</th>
